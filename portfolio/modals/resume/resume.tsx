  ...
  return (
    <div className={`flex flex-col w-full h-full overflow-y-auto ${styles.iframeLoader}`}>
      ...
      <iframe
        ...
        title="Resume"
        src="https://texlive2020.latexonline.cc/compile?git=https://github.com/yasir-fayrooz/yasir-fayrooz-resume/blob/main/cv.tex&command=lualatex&force=true" //&force=true to force re-compile
      ></iframe>
